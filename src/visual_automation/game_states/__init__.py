...
from visual_automation.game_states.combat import (
...
from visual_automation.game_states.inventory import InventoryStatus, detect_inventory_status
from visual_automation.game_states.template_matching import (
    TemplateSearchResult,
    best_template_match,
    wait_for_template_match,
)
from visual_automation.game_states.template_sequence import (
    TemplateStep,
    fallback_candidates,
    load_template_steps,
    rotate_steps,
