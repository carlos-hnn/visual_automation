...
from visual_automation.core.debug import save_annotated_match
...
from visual_automation.definitions import ROOT, TemplateSequenceDefaults
from visual_automation.game_states import (
    TemplateStep,
    fallback_candidates,
    load_template_steps,
    rotate_steps,
...
from visual_automation.game_states.template_matching import best_template_match, parse_scales
from visual_automation.game_states.template_sequence import parse_order
