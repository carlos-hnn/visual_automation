...
SCRIPTS = {
    ...
    "blast_furnace": ("Blast Furnace", "scripts/blast_furnace.py", "config/blast_furnace.example.json"),
    ...
    "mine_bank": ("Mine + Bank", "scripts/mine_bank.py", "config/mine_bank.example.json"),
